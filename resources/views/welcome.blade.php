<x-guest-layout title="Home">
    ...
    <!-- hero start -->
    <section class="hero bg_img" data-background="assets/images/frontend/banner/5fce371bad7db1607350043.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="hero__content">
                        <h2 class="hero__title"><span class="text-white font-weight-normal">Invest for Future in a
                                Stable Platform</span> <b class="base--color">and Make A Profit</b></h2>
                        <p class="text-white f-size-18 mt-3">Invest in {{config("app.name")}}, where the future of your
                            finance is always green. We don&#039;t just believe in your financial dreams, we give you
                            tools and resources needed to make your financial dreams come true.</p>
                        <a href="register.php" class="cmn-btn text-uppercase font-weight-600 mt-4">Sign Up</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="about-section pt-120 pb-120 bg_img"
        data-background="assets/images/frontend/about/60b60b6574cd91622543205.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-6">
                    <div class="about-content">
                        ...
                        <p>We are an international financial company engaged in investment activities, which are related
                            ...
                            <br /> Our goal is to provide our investors with a reliable source of high income, while
                            minimizing any possible risks and offering a high-quality service, allowing us to automate
                            and simplify the relations between the
                            investors and the trustees. We work towards increasing your profit margin by profitable
                ...
                <div class="col-lg-6 text-center">
                    <div class="section-header">
                        <h2 class="section-title"><span class="font-weight-normal">Why Choose</span> <b
                                class="base--color">{{ config('app.name', 'Laravel') }}?</b></h2>
                        <p>Here Are Our 9 commitments to you</p>
                    </div>
                </div>
            </div>
            <!-- row end -->
    ...
    <section class="pt-120 pb-120 bg_img" data-background="assets/images/frontend/how_work/5fce39883b22c1607350664.jpg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <div class="section-header">
                        <h2 class="section-title"><span class="font-weight-normal">How</span> <b class="base--color">{{
                                config('app.name', 'Laravel') }}</b> <span class="font-weight-normal">Works</span>
                        </h2>
            ...
            <div class="row justify-content-center mb-none-30">
                <div class="col-lg-4 col-md-6 work-item mb-30">
                    <div class="work-card text-center">
                        ...
                        <div class="work-card__content">
                            <h4 class="base--color mb-3">Create Your Account</h4>
                        </div>
                    </div>
                    <!-- work-card end -->
                </div>
                <div class="col-lg-4 col-md-6 work-item mb-30">
                    <div class="work-card text-center">
                        ...
                        <div class="work-card__content">
                            <h4 class="base--color mb-3">Invest In A Plan</h4>
                        </div>
                    </div>
                    <!-- work-card end -->
                </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapse0" class="collapse" aria-labelledby="heading0"
                                ...
                                <div class="card-body">
                                    ...
                                    in your dashboard on the main page of Investing platform. </div>
                            </div>
                        </div>
                        <div class="card">
                        ...
                        <div class="card">
                            ...
                            <div id="collapse3" class="collapse" aria-labelledby="heading3"
                                ...
                                <div class="card-body">
                                    ...
                                    long it will take for the funds to reach you. You will get an automatic notification
                                    once
                                    we send the funds and you can always check your transactions or account balance.
                                    Your chosen payment system dictates how long it will take for the funds to reach
                                    you. </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div id="collapse4" class="collapse" aria-labelledby="heading4"
                                ...
                                <div class="card-body">
                                    ...
                                    used currently for supporting opened positions. You can withdraw the full amount of
                                    your account balance minus the funds that are used currently for supporting opened
                                    positions.
                                </div>
                            </div>
                        </div>
    ...
    <section class="pt-120 pb-120 bg_img overlay--radial"
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <div class="section-header">
                        <h2 class="section-title"><span class="font-weight-normal">Every investor</span> <b
                                class="base--color">has a story to tell</b></h2>
                        <p>See how Live Capital Trade has changed the way people see their finances—and themselves.</p>
                    </div>
                </div>
            </div>
            <!-- row end -->
                ...
                <div class="col-lg-12">
                    <div class="testimonial-slider">
                        <div class="single-slide">
                            <div class="testimonial-card">
                                ...
                                <div class="testimonial-card__client">
                                    <div class="thumb">
                                        <img src="assets/images/frontend/testimonial/62269c27869601646697511.jpg"
                                            alt="image">
                                    </div>
                                    <div class="content">
                                        <h6 class="name">Thakur Sui</h6>
                                        <span class="designation">South Korea.</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single-slide">
                            <div class="testimonial-card">
                                <div class="testimonial-card__content">
                                    <p>Legit....and legit. Although the payment was processed manually, I have received
                                        my first payment within a very short time., I think nice for invest at this
                                        site.</p>
                                </div>
                                <div class="testimonial-card__client">
                                    <div class="thumb">
                                        <img src="assets/images/frontend/testimonial/62269c74627c91646697588.jpg"
                                            alt="image">
                                    </div>
                                    <div class="content">
                        ...
                        <div class="single-slide">
                            <div class="testimonial-card">
                                <div class="testimonial-card__content">
                                    <p>You can invest in them and good l....................reports!</p>
                                </div>
                                <div class="testimonial-card__client">
                                    <div class="thumb">
                                        <img src="assets/images/frontend/testimonial/5fce3c918a04b1607351441.jpg"
                                            alt="image">
                                    </div>
                                    <div class="content">
                                        <h6 class="name">Donny Truz</h6>
    ...
    <section class="pt-120 pb-120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <div class="section-header">
                        <h2 class="section-title"><span class="font-weight-normal"></span> <b class="base--color"></b>
                        </h2>
                        <p>Here is the log of the most recent transactions including withdraw and deposit made by our
                            users.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="cta-wrapper bg_img border-radius--10 text-center"
                        ...
                        <h2 class="title mb-3">Investing For Everyone</h2>
                        <p>Get amazing investing, plus the tools you need to put your money in motion. Sign up and get
                            your $10 Signup bonus.</p>
                        <a href="https://livecapitaltrad.com/register" class="cmn-btn mt-4">Join Us</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="payment-slider">
                        ...
                        <div class="single-slide">
                            <div class="brand-item">
                                <img src="assets/images/gateway/622787323060e1646757682.jpg" alt="image">
                            </div>
                            <!-- brand-item end -->
                        </div>
                        <div class="single-slide">
                            <div class="brand-item">
                                <img src="assets/images/gateway/62278b1e9045c1646758686.png" alt="image">
                            </div>
                            <!-- brand-item end -->
                        </div>
                        <div class="single-slide">
                            <div class="brand-item">
                                <img src="assets/images/gateway/622794f819b471646761208.png" alt="image">
                            </div>
                            <!-- brand-item end -->
                        </div>
                        <div class="single-slide">
                            <div class="brand-item">
                                <img src="assets/images/gateway/62278e3f51a021646759487.png" alt="image">
                            </div>
                            <!-- brand-item end -->
                        </div>
                        <div class="single-slide">
                            <div class="brand-item">
                                <img src="assets/images/gateway/6227906015df81646760032.png" alt="image">
                            </div>
                            <!-- brand-item end -->
                        </div>
                    </div>
